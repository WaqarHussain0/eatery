...
function Navbar() {
  return (
    <Row className=" w-full bg-[#590017] justify-around items-center py-[10px]">
      <Row>
        <img src={logo} className="h-[100px] w-[65px] " alt="..." />
      </Row>

      <Row
        className="leading-[26px] text-[#ffffff]
        gap-[40px] text-[18px] font-normal justify-center cotoris z-[1]"
      >
        <Link to="/"> <p>Home</p></Link>
        <Link to="/menu"> <p>Menu</p></Link>
        <Link to="/about"><p>Venu</p></Link>
      </Row>

      <Row>
        <button className="cotoris-bold w-[110px] h-[40px] bg-[#CC9D2F] text-[#5B0017]">
          Book Now
        </button>
        <svg
          width="20"
